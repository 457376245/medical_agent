...
def test_record_source_type_update_endpoint_contract_present() -> None:
    openapi = read_text("specs/001-medical-agent-mvp/contracts/openapi.yaml")
    assert_contains_all(
        openapi,
        [
            "/records/{recordId}/source-type:",
            "operationId: updateRecordSourceType",
            "ApiResponseRecordSourceTypeUpdate",
        ],
    )

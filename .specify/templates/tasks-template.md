...
**Tests**: Risk-based testing is REQUIRED. High-risk flows (upload, parse, generate,
save, delete/export, auth/privacy/security boundaries) MUST include automated tests.
Lower-risk changes MUST include explicit manual verification tasks.
...
- [ ] T010 [P] Define audit events and sensitive-log redaction rules
- [ ] T011 [P] Define contract/schema versioning approach for this feature
...
### Tests for User Story 1 (REQUIRED for high-risk paths) ⚠️
...
- [ ] T014 [US1] Manual verification task for disclaimer and high-risk reconfirmation UX
...
- [ ] T020 [US1] Add structured logging and audit trail hooks
...
### Tests for User Story 2 (REQUIRED for high-risk paths) ⚠️
...
- [ ] T023 [US2] Manual verification task for async timeout/retry user feedback
...
### Tests for User Story 3 (REQUIRED for high-risk paths) ⚠️
...
- [ ] T030 [US3] Manual verification task for low-confidence field correction flow
...
- [ ] TXXX [P] Additional unit tests for regression-sensitive modules in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Contract/schema version compatibility verification
- [ ] TXXX Audit log completeness verification
...
- Tests for high-risk flows MUST be written and FAIL before implementation
- Lower-risk changes MUST include explicit manual verification tasks
...
- Verify disclaimer, confirmation, and audit requirements in validation
